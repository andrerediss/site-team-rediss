...
import { ArrowRight, CalendarDays, ChevronLeft, MapPin, Users } from "lucide-react";
import { useReveal } from "@/hooks/use-reveal";

export const Route = createFileRoute("/treinar/turma/studio-top-fitness/")({
  component: TurmaStudioTopFitnessPage,
  head: () => ({
    meta: [
      { title: "Muay Thai Turma — Studio Top Fitness — André Rediss" },
      {
        name: "description",
        content:
...
function TurmaStudioTopFitnessPage() {
    ...
    <main className="min-h-screen bg-background text-foreground">
      ...
      <div ref={heroRef} className="fade-up px-6 pb-2 pt-10 text-center">
        ...
        <p className="mx-auto mt-4 max-w-md text-muted-foreground">
          Turma reduzida com no máximo 5 alunos. Aprenda Muay Thai em um ambiente motivador, com
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-sm leading-relaxed text-muted-foreground">
                R. Osvaldo Rodrigues De Lemos, 471 — Columbia City
                <br />
                Guaíba — RS, 92717-850
              </p>
              <a
                href="https://maps.google.com/?q=R.+Osvaldo+Rodrigues+De+Lemos,+471,+Columbia+City,+Guaíba,+RS"
                target="_blank"
      ...
      <section className="mx-auto max-w-lg px-6 pb-16 pt-4">
        <Link
          to="/treinar/turma/studio-top-fitness/interesse"
