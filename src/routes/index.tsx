...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://www.rediss.cloud/logo.png" },
      { property: "og:url", content: "https://www.rediss.cloud" },
      ...
      { name: "twitter:image", content: "https://www.rediss.cloud/logo.png" },
      { tagName: "link", rel: "canonical", href: "https://www.rediss.cloud" },
    ],
  }),
});
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center text-center">
        ...
        <p className="mb-6 font-display text-xl font-black uppercase tracking-[0.5em] text-white">
          Team Rediss
        </p>
