...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://www.andrerediss.com/logo.png" },
      { property: "og:url", content: "https://www.andrerediss.com" },
      ...
      { name: "twitter:image", content: "https://www.andrerediss.com/logo.png" },
      { tagName: "link", rel: "canonical", href: "https://www.andrerediss.com" },
    ],
  }),
});
