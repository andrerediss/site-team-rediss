...
function ServiceCard({
  ...
  return (
    <div ref={ref} className="fade-up" style={{ transitionDelay: `${delay}ms` }}>
      <Link
        to={to}
        className="group flex items-center justify-between gap-4 border border-border/50 border-t-2 border-t-primary bg-card px-6 py-6 transition hover:border-primary/60 hover:bg-[oklch(0.11_0_0)]"
      >
